...
public class PetProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        if (name == null) {
            Toast.makeText(getContext(), "Pet requires a name",
...
//        values.put(PetEntry.COLUMN_PET_GENDER, mGender);
        ...
        if (breed == null) {
            Toast.makeText(getContext(), "Breed not provided..",
                    Toast.LENGTH_SHORT).show();
            throw new IllegalArgumentException("Breed not provided..");
        }

        String weight = values.getAsString(PetEntry.COLUMN_PET_WEIGHT);
        if (weight == null) {
            Toast.makeText(getContext(), "Weight not provided..",
                    Toast.LENGTH_SHORT).show();
